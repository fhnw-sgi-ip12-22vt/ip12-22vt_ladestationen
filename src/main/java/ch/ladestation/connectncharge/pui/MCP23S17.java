 ...
 * </p>
 * <p>
 * This class abstracts away the technical details of communicating with the
 * chip via SPI, allowing for simple access
 * via {@link PinView PinView} objects. One {@code PinView} object exists per
 * {@link Pin Pin}, and {@code PinView}
 * objects are initialized lazily. {@code PinView} references are returned by
 * {@link MCP23S17#getPinView(Pin) getPinView}.
 * </p>
 * <p>
 * It is critical to note that, to allow for writing to the MCP23S17's registers
 * in batches, the setter methods on
 * {@code PinView}s (or, in general, the methods that modify state for that pin)
 * do not actually perform a write to the
 * chip; they merely set program state. In order to write to the chip, each
 * invocation of a state-changing
 * {@code PinView} method (or a batch thereof) must be followed by a call to the
 * appropriate {@code writeXXX} method(s)
 * on the {@code MCP23S17} object.
 * </p>
 * <p>
 * To setup the chip to use interrupts, the interrupt {@linkplain DigitalInput
 * input pins} must be passed in
 * during construction at the appropriate static factory method; one static
 * factory method is provided for each possible
 * interrupt setup. Once a chip is setup for interrupts, callbacks for both
 * {@linkplain PinView#addListener(InterruptListener) pin-specific interrupts}
 * and
 * {@linkplain MCP23S17#addGlobalListener(InterruptListener) global interrupts}
 * may be registered. Do note, however,
 * that each pin that is supposed to generate interrupts must be setup as such
 * in the appropriate registers. Refer to
 * the <a
 * href=http://ww1.microchip.com/downloads/en/DeviceDoc/20001952C.pdf>MCP23S17
 * datasheet</a> for more
 * information.
 * </p>
 *
...
// changes would simply be forgotten without (as is currently the case) local
// state potentially becoming
// out-of-sync with the actual values in the registers on the chip. Maybe this
// is over-engineering it though...
public final class MCP23S17 extends Component {
     ...
     * </p>
     * <p>
     * The pins are renumbered so that port A's pins are in order as {@code PIN0}
     * through {@code PIN7} and port B's pins
    ...
    public enum Pin {
        ...
        /**
         * A bit mask which is used in {@link Pin#getCorrespondingBit(byte)
         * getCorrespondingBit} and
         * {@link Pin#setCorrespondingBit(byte, boolean) setCorrespondingBit}.
         */
        private final byte mask;

        /**
         * @param bitIndex the index of the pin in the bytes which concern it (i.e. the
         *                 pin number <code>mod 8</code>).
         ...
         * </p>
         * <p>
         * The pins are numbered so that port A's pins are in order as {@code 0} through
         * {@code 7} and port B's pins are
        ...
        /**
         * Given two bytes, one corresponding to port A and one corresponding to port B,
         * return the one corresponding to
        ...
        /**
         * Given a byte, index it and return the bit corresponding to this pin. (The
         * index is given by this
        ...
        /**
         * Given a byte, set the bit corresponding to this pin to the given value and
         * return the resulting byte. (The
         ...
         * @throws IllegalArgumentException if the given pin number is invalid (i.e.
    ...
    public final class PinView {
        ...
        /**
         * The listeners registered specifically to this pin (i.e. not global
         * listeners). This object is synchronized on
         * so that listeners cannot be added or removed while an interrupt is being
        ...
        /**
         * Get the state of the pin. If the pin is output, then the corresponding bit in
         * the corresponding OLATx byte is
         * returned (note: not the actual value in the MCP23S17's OLATx register). If
         * the pin in input, then the actual
        ...
        /**
         * Set the pin to the given state. More specifically, this sets the
         * corresponding bit in the corresponding OLATx
         * byte (note: not the actual value in the MCP23S17's OLATx register) to the
         * given state.
         *
        ...
        /**
         * Sets the pin high. More specifically, this sets the corresponding bit in the
         * corresponding OLATx byte (note:
        ...
        /**
         * Clears the pin (sets it low). More specifically, this clears the
         * corresponding bit in the corresponding OLATx
        ...
        /**
         * Get whether or not this pin is input. More specifically, this returns the
         * corresponding bit in the
         * corresponding IODIRx byte (note: not the actual value in the MCP23S17's
         * IODIRx register).
         *
        ...
        /**
         * Get whether or not this pin is output. More specifically, this returns the
         * inverse of the corresponding bit
         * in the corresponding IODIRx byte (note: not the actual value in the
         * MCP23S17's IODIRx register).
         *
        ...
        /**
         * Set the pin to the given direction. More specifically, this sets the
         * corresponding bit in the corresponding
         * IODIRx byte (note: not the actual value in the MCP23S17's IODIRx register) if
         * the pin direction is input, and
        ...
        /**
         * Set the pin to be input. More specifically, this sets the corresponding bit
         * in the corresponding IODIRx byte
        ...
        /**
         * Set the pin to be output. More specifically, this clears the corresponding
         * bit in the corresponding IODIRx
        ...
        /**
         * Get whether or not this pin's input is inverted. More specifically, this
         * returns the corresponding bit in the
         * corresponding IPOLx byte (note: not the actual value in the MCP23S17's IPOLx
         * register).
         *
        ...
        /**
         * Set whether or not the pin's input is inverted. More specifically, this sets
         * the corresponding bit in the
         * corresponding IPOLx byte (note: not the actual value in the MCP23S17's IPOLx
         * register) if the pin's input is
        ...
        /**
         * Set the pin's input to be inverted. More specifically, this sets the
         * corresponding bit in the corresponding
        ...
        /**
         * Set the pin's input to not be inverted. More specifically, this clears the
         * corresponding bit in the
         * corresponding IPOLx byte (note: not the actual value in the MCP23S17's IPOLx
         * register).
         */
        ...
        /**
         * Get whether or not this pin's interrupt is enabled. More specifically, this
         * returns the corresponding bit in
         * the corresponding GPINTENx byte (note: not the actual value in the MCP23S17's
         * GPINTENx register).
         *
        ...
        /**
         * Set whether or not the pin's interrupt is enabled. More specifically, this
         * sets the corresponding bit in the
         * corresponding GPINTENx byte (note: not the actual value in the MCP23S17's
         * GPINTENx register) if interrupts
        ...
        /**
         * Enable the pin's interrupts. More specifically, this sets the corresponding
         * bit in the corresponding GPINTENx
        ...
        /**
         * Disable the pin's interrupts. More specifically, this clears the
         * corresponding bit in the corresponding
         * GPINTENx byte (note: not the actual value in the MCP23S17's GPINTENx
         * register).
         */
         ...
         * More specifically, this returns
         * the corresponding bit in the corresponding DEFVALx byte (note: not the actual
         * value in the MCP23S17's DEFVALx
         * register).
         *
         * @return the default comparison value for comparison interrupt mode for this
         *         pin.
         */
         ...
         * corresponding bit in the corresponding DEFVALx byte (note: not the actual
         * value in the MCP23S17's DEFVALx
         * register) to the given value.
         *
         * @param value the default comparison value for comparison interrupt mode for
         *              this pin.
         */
        ...
        /**
         * Get whether or not this pin is in interrupt comparison mode (as opposed to
         * change mode). More specifically,
         * this returns the corresponding bit in the corresponding INTCONx byte (note:
         * not the actual value in the
        ...
        /**
         * Get whether or not this pin is in interrupt change mode (as opposed to
         * comparison mode). More specifically,
         * this returns the inverse of the corresponding bit in the corresponding
         * INTCONx byte (note: not the actual
        ...
        /**
         * Set the interrupt mode for this pin. More specifically, this sets the
         * corresponding bit in the corresponding
         * INTCONx byte (note: not the actual value in the MCP23S17's INTCONx register)
         * if transitioning to comparison
        ...
        /**
         * Set the interrupt mode to comparison mode. More specifically, this sets the
         * corresponding bit in the
         * corresponding INTCONx byte (note: not the actual value in the MCP23S17's
         * INTCONx register).
         */
        ...
        /**
         * Set the interrupt mode to change mode. More specifically, this clears the
         * corresponding bit in the
         * corresponding INTCONx byte (note: not the actual value in the MCP23S17's
         * INTCONx register).
         */
        ...
        /**
         * Get whether or not this pin has a pull-up resistor enabled. More
         * specifically, this returns the corresponding
         * bit in the corresponding GPPUx byte (note: not the actual value in the
         * MCP23S17's GPPUx register).
         *
        ...
        /**
         * Set whether or not this pin has a pull-up resistor enabled. More
         * specifically, this sets the corresponding
         * bit in the corresponding GPPUx byte (note: not the actual value in the
         * MCP23S17's GPPUx register) if pull-up
         * resistors are being enabled, and clears it if pull-up resistors are being
         * disabled.
         *
        ...
        /**
         * Enables pull-up resistors for this pin. More specifically, this sets the
         * corresponding bit in the
         * corresponding GPPUx byte (note: not the actual value in the MCP23S17's GPPUx
         * register).
         */
        ...
        /**
         * Disables pull-up resistors for this pin. More specifically, this clears the
         * corresponding bit in the
         * corresponding GPPUx byte (note: not the actual value in the MCP23S17's GPPUx
         * register).
         */
         ...
         * </p>
         * <p>
         * This does no error checking with respect to whether or not interrupts are
         * enabled for this pin or whether or
         * not they even could be effectively enabled.
         * </p>
         *
         * @implSpec This is synchronized on the collection of listeners, so it is
         *           thread safe.
         *
         ...
         * @throws IllegalArgumentException if the given listener was not previously
         *                                  registered.
         * @throws NullPointerException     if the given listener is {@code null}.
         */
        ...
        /**
         * Invoke all the interrupt listeners registered to receive events specifically
         * for this pin with the given
         * captured value. This is called from
         * {@link MCP23S17#callInterruptListeners(byte, byte, Pin[])
    ...
    /**
     * A {@linkplain FunctionalInterface functional interface} representing an
     * interrupt listener callback.
     * {@code InterruptListener}s are registered via
     * {@link MCP23S17#addGlobalListener(InterruptListener) addGlobalListener} on
     * {@link MCP23S17 MCP23S17} objects and
     * {@link PinView#addListener(InterruptListener) addListener} on {@link PinView
     * PinView} objects, and removed by the
    ...
    public interface InterruptListener {
        ...
        /**
         * Called whenever an interrupt occurs on a pin for which this listener is
    ...
    // OPCODES--these are written before a register address in the read and write
    // processes.
    ...
    /**
     * Stores whether this chip will read the GPIO registers to check for state
     * change on the pins
    ...
    /**
     * The lazily-instantiated {@link PinView PinView}s. This object is synchronized
     * on in
     * {@link MCP23S17#getPinView(Pin) getPinView} as {@code PinView}s are accessed
     * in the
     * {@linkplain MCP23S17#callInterruptListeners(byte, byte, Pin[]) interrupt
     * handling routine} (which is invoked in a
     * different thread).
     */
    private final EnumMap<Pin, PinView> pinViews = new EnumMap<>(Pin.class);

    /**
     * The registered global listeners--not pin-specific listeners. This object is
     * synchronized on so that listeners
     * cannot be added or removed while an interrupt is being processed or vice
     * versa.
     */
    ...
    // They are initialized to the corresponding registers' initial value, as given
    // in the MCP23S17 datasheet.
     ...
     * bytes is written to so that two
     * threads may not write to the same byte at the same time. Ideally we would
     * have one lock per byte because, for
     * example, a thread writing only to IODIRB need not yield to a thread writing
     * only to IODIRA, but then we would
     * have fourteen lock objects! Byte writes should be infrequent enough and fast
    ...
    /**
     * This is the first out of two private constructors.--the static factory
     * methods must be used for object creation.
     *
     * @param bus            the SPI-Bus that the chip is connected to.
     * @param chipSelect     the {@linkplain DigitalOutput output pin} controlling
     *                       the chip select line on the chip.
     * @param portAInterrupt the {@linkplain DigitalInput input pin} for the port A
     *                       interrupt line on the chip,
     *                       or {@code null}.
     * @param portBInterrupt the {@linkplain DigitalInput input pin} for the port B
     *                       interrupt line on the chip,
     *                       or {@code null}.
     * @param readGPIO       whether to read from the GPIO registers or the INTCAP
     *                       registers on interrupt.
    ...
    /**
     * This is the same as the first out of the two private constructors, it is just
     * a helper to emulate default parameters via overloading.
     *
     * @param bus            the SPI-Bus that the chip is connected to.
     * @param chipSelect     the {@linkplain DigitalOutput output pin} controlling
     *                       the chip select line on the chip.
     ...
     * It is used for adding more ICs to the same SPI-Bus. See
     * {@code MCP23S17.multipleNewOnSameBus()}.
     * Note that the Address pins are disabled by default. The factory method
     * enables them.
     ...
     *                       registers on interrupt.
     * @throws IOException          if the instantiation of the {@link Spi Spi}
     *                              object fails.
     * @throws NullPointerException if the given chip select output is {@code null}.
     */
    ...
    public PinView getPinView(Pin pin) {
        PinView pinView;
        // This is called from callInterruptListeners when an interrupt occurs, hence
        // the need for sync.
    ...
    /**
     * <p>
     * Get an {@link Iterator Iterator} over all the {@link PinView PinView}s for
     * this {@code MCP23S17}.
     * </p>
     * <p>
     * The returned {@code Iterator} returns the {@code PinView}s in the order of
     * their pin numbers (i.e. the
     * {@code PinView} for {@link Pin#PIN0 PIN0} comes first and the {@code PinView}
     * for {@link Pin#PIN15 PIN15} comes
     * last). The returned {@code Iterator} does not support
     * {@linkplain Iterator#remove() removal of elements}.
     * </p>
     * <p>
     * Note that if certain {@code PinView}s have not yet been lazily-loaded, they
     * will be loaded as needed by the
     * returned {@code Iterator}.
     * </p>
     *
     * @return an iterator over all the {@link PinView PinView}s for this
     *         {@code MCP23S17}.
     */
     ...
     * The correct values are also being written to the corresponding registers and
     * the
     * GPIO registers are read once to clear any pending interrupts on startup.
     *
     * @return an {@link ArrayList} of 16 {@linkplain PinView} objects that are all
     *         configured to be inpputs, pulled up and interrupt-on-change enabled.
     ...
     * </p>
     *
     * @implSpec This is synchronized on the collection of global listeners, so it
     *           is thread safe.
     *
     * @param listener the global listener to add.
     * @throws IllegalArgumentException if the given global listener is already
     *                                  registered.
     * @throws NullPointerException     if the given global listener is
     *                                  {@code null}.
     */
     ...
     * @throws IllegalArgumentException if the given global listener was not
    ...
    /**
     * Initiate SPI communication with the chip and write a byte to the register
     * pointed to by the given address.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    private void write(byte registerAddress, byte value) {
        // Without testing it is unclear whether the synchronization here is
        // necessary--the documentation on read
        // is poor.
        synchronized (spi) {
            try {
                chipSelect.low();
    ...
    /**
     * Initiate SPI communication with the chip and write the IODIRA byte to the
     * IODIRA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the IODIRB byte to the
     * IODIRB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the IPOLA byte to the
     * IPOLA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the IPOLB byte to the
     * IPOLB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the GPINTENA byte to the
     * GPINTENA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the GPINTENB byte to the
     * GPINTENB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the DEFVALA byte to the
     * DEFVALA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the DEFVALB byte to the
     * DEFVALB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the INTCONA byte to the
     * INTCONA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the INTCONB byte to the
     * INTCONB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the GPPUA byte to the
     * GPPUA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the GPPUB byte to the
     * GPPUB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the OLATA byte to the
     * OLATA register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and write the OLATB byte to the
     * OLATB register.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
    ...
    /**
     * Initiate SPI communication with the chip and read a byte from the register
     * pointed to by the given address.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} object so that two or
     *           more reads/writes cannot be
     *           initiated at the same time.
     *
     * @param registerAddress the register address.
    ...
    /**
     * Initiate SPI communication with the chip and read a byte from the register
     * pointed to by the given address. This
     * will rethrow any {@link IOException IOException}s that occur as
     * {@link RuntimeException RuntimeException}s.
     *
     * @implSpec This is synchronized on the {@link Spi Spi} so that two or more
     *           reads/writes cannot be
     *           initiated at the same time.
     ...
     * @param registerAddress the register address.
     * @return the byte read from the register.
     * @throws RuntimeException if the SPI read procedure fails (rethrown from
     *                          {@code IOException}).
     */
    ...
    /**
     * This is the callback for when port A interrupts occur. Read the INTFA and
     * INTCAPA or GPIOA registers
     * depending on {@code readGPIORegisterOnInterrupt} and alert all the
     * appropriate {@linkplain InterruptListener interrupt listeners} of the
     * interrupt.
     */
    ...
    /**
     * This is the callback for when port B interrupts occur. Read the INTFB and
     * INTCAPB or GPIOB registers
     * depending on {@code readGPIORegisterOnInterrupt} and alert all the
     * appropriate {@linkplain InterruptListener interrupt listeners} of the
     * interrupt.
     */
    ...
    /**
     * Using the given state of the INTFx register, determine which of the given
     * {@linkplain Pin pins} is responsible
     * for generating an interrupt. Then, call all the global listeners and
     * pin-specific listeners for the pin which
     * generated the interrupt with the captured value of the pin at the time of the
     * interrupt.
     *
     ...
     * @param pins   either {@link MCP23S17#PORT_A_PINS PORT_A_PINS} or
     *               {@link MCP23S17#PORT_B_PINS PORT_B_PINS},
    ...
    private void callInterruptListeners(byte intf, byte intcap, Pin[] pins) {
        for (Pin pin : pins) {
            if (pin.getCorrespondingBit(intf)) {
                ...
                // This can in rare cases where the IO expander is already configured create a
                // PinView object before the
    ...
    /**
     * Instantiate a number of {@code MCP23S17} objects on the same bus with
     ...
     * @throws IOException              if the instantiation of the {@link Spi Spi}
     *                                  object fails.
     * @throws IllegalArgumentException if there are too few/many chips on the bus
     *                                  ({@code amount} not in range 1-8)
     * @throws NullPointerException     if the given chip select output is
     *                                  {@code null}.
     */
    public static ArrayList<MCP23S17> multipleNewOnSameBus(Context pi4j,
        ...
        // write command.
        // this enables every chip assuming they are connected to the same SPI bus and
        // Chip select
    ...
    /**
     * Instantiate multiple new {@code MCP23S17} objects on the same SPI-bus with
     * their hardware address pins enabled
     * and with their port A and port B interrupt lines "tied" together.
     *
     * @param pi4j       the pi4j {@link Context} object
     * @param bus        the {@link SpiBus} with which to communicatee with the
     *                   chips
     * @param interrupts an array of {@link DigitalInput}s to listen for interrupts
     *                   from the chips
     * @param amount     the amount of ICs on the bus
     * @param readGPIO   true if on interrupt the GPIO registers should be read
     *                   instead of the INTCAP registers
     * @throws IllegalArgumentException if the amount isn't in the range 1-8 or
     *                                  {@code interrupts.length} is smaller than
     *                                  amount
     * @throws IOException              if the instantiation of the {@link Spi Spi}
     *                                  object fails.
    ...
    public static ArrayList<MCP23S17> multipleNewOnSameBusWithTiedInterrupts(Context pi4j,
        ...
        // need to enable the hardware address pins by sending the appropriate address
        // write command.
        // this enables every chip assuming they are connected to the same SPI bus and
        // Chip select
    ...
    /**
     * Instantiate a new {@code MCP23S17} object with the port A and port B
     * interrupt lines "tied" together.
     *
     * @param bus        the SPI-Bus that the chip is connected to.
     * @param chipSelect the {@linkplain DigitalOutput output pin} controlling the
     *                   chip select line on the chip.
    ...
    /**
     * Instantiate a new {@code MCP23S17} object with individual port A and port B
     * interrupt lines.
     *
     * @param bus            the SPI-Bus that the chip is connected to.
     * @param chipSelect     the {@linkplain DigitalOutput output pin} controlling
    ...
    /**
     * Instantiate a new {@code MCP23S17} object with an individual port A interrupt
    ...
    /**
     * Instantiate a new {@code MCP23S17} object with an individual port B interrupt
    ...
    /**
     * Attach a {@link Runnable Runnable} callback to the given
     * {@linkplain DigitalInput input pin} to be invoked

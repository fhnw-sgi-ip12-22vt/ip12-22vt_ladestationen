...
Weitere Informationen über die Aufgabenstellung ist unter dem link:docu/software/others/IP12-22vt_Ladestationen.pdf[IP12-22vt_Ladestationen.pdf] vorhanden.

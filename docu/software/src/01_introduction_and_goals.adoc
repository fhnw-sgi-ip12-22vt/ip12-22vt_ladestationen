...
Weitere Informationen über die Aufgabenstellung ist unter dem link:https://www.dropbox.com/s/0ajk0gmgg55e9ou/IP12-22vt_Ladestationen.pdf?dl=0[IP12-22vt_Ladestationen.pdf] vorhanden.

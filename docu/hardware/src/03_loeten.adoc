...
=== PCB / Platine
****
Das PCB verbindet alle Komponenten auf Hardwareebene mit der Verkabelung.
Es wurde in Fusion 360 designed. Für die files, siehe link:../resources/PCB/PCB_v29_2023-03-27.zip[PCB-Files]

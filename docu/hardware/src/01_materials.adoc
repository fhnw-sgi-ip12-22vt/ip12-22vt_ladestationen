...
|18CHF
|5x
|Custom PCB für die GPIO extension chips. +
Bestellt bei link:https://www.pcbway.com/[PCBway] ($10 Versandkosten + $8 für 5 PLatinen (Mindestbestellmenge) +
link:../resources/PCB/PCB_v29_2023-03-27.zip[PCB-Files]
